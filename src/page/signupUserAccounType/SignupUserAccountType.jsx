...
function SignupUserAccountType() {
  return (
    <Box>
      ...
      >
        Bienvenue sur <span style={{ color: "#3D64FF" }}>BFBilleterie !!</span>
      </Typography>
      ...
      >
        ...
        >
          ...
          <Box sx={{ bgcolor: "#F4F2FF", height: "50%", padding: "40px 30px" }}>
            ...
            >
              <Typography
                sx={{ fontSize: "13px", color: "#6E6893", textAlign: "center" }}
              >
                Prêt à vivre des expériences uniques? Rejoignez-nous maintenant
                pour découvrir et participer à des événements passionnants!
              </Typography>
            </Box>
